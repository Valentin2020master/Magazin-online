            ...
            <div class="col-md-9 single-main-left">
                    ...
                    <div class="col-md-7 single-top-right">
                        <div class="single-para simpleCart_shelfItem">
                            ...
                            <?php if ($product->old_price): ?>
                                    <del><?=$product->old_price * $curr['value'];?>
                                    </del>
                            <?php endif; ?>
                            <?=$product->content;?>
                            <?php if($mods):?>
                            <div class="available">
                                <ul>
                                    <li>Color
                                        <select>
                                            <option>Alegeti culoarea</option>
                ...
                <div class="latestproducts">
                    <div class="product-one">
                        <h3>De asemenea, clienții cumpără cu acest produs:</h3>
