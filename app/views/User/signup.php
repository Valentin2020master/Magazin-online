...
<div class="breadcrumbs">
    <div class="container">
        <div class="breadcrumbs-main">
            <ol class="breadcrumb">
                <li><a href="<?= PATH ?>">Pagina principală</a></li>
                <li>Înregistrarea</li>
            </ol>
        </div>
    </div>
                        ...
                        <div class="col-md-6 account-left">
                            <form method="post" action="user/signup" id="signup" role="form" data-toggle="validator">
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <input type="password" name="password" class="form-control" id="pasword" placeholder="Password" data-error="Parola trebuie să conțină nu mai puțin de 6 caractere" data-minlength="6" required>
                                    <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                    <div class="help-block with-errors"></div>
                                </div>
                                <div class="form-group has-feedback">
                                    <label for="name">Numele</label>
                                    <input type="text" name="name" class="form-control" id="name" placeholder="Numele" value="<?=isset($_SESSION['form_data']['name']) ? h($_SESSION['form_data']['name']) : '';?>" required>
                                    <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                </div>
                                <div class="form-group has-feedback">
                                ...
                                <button type="submit" class="btn btn-default">Înregistreazămă</button>
                            </form>
