                    ...
                    <?php if(!empty($_SESSION['cart'])):?>
                            ...
                            <table class="table table-hover table-striped">
                                ...
                                <?php foreach($_SESSION['cart'] as $id => $item): ?>
                                    <tr>
                                        ...
                                        <td><?=$item['qty'] ?></td>
                                        <td><?=$item['price'] ?><?=$_SESSION['cart.currency']['symbol_left'] . $_SESSION['cart.currency']['symbol_right'];?></td>
                        ...
                        <div class="col-md-6 account-left">
                            <form method="post" action="cart/checkout" role="form" data-toggle="validator">
                                ...
                                <button type="submit" class="btn btn-default">Finalizare comandă</button>
                            </form>
